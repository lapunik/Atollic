 ...
 */
#define _MBED_LCD_NUCLEO_ENUM_OUT_PP  ioPortOutputPushPull
/**
 * Constant for ioMode parameter in ..SET_GPIO - mode ALternate Funcion with PushPull
 * Typically represented by enum
 */
#define _MBED_LCD_NUCLEO_ENUM_AF_PP  ioPortAlternatrPushPull
